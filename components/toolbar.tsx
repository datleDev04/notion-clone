...
const ToolBar = ({
    ...
    const reomveIcon = useMutation(api.documents.removeIcon)
    ...
    const onRemoveIcon = () => {
        reomveIcon({ documentId: initialData._id  })
    }
    ...
    <div className="pl-[54px] group relative">
        {!!initialData.icon && !preview && (
            <div className="flex items-center gap-x-2  group/icon pt-6">
                ...
                <Button className="rounded-full opacity-0 
                group-hover/icon:opacity-100 transition text-muted-foreground text-xs"
                    variant="outline"
                    size="icon"
        ...
        {isEditing && !preview ? (
            <TextareaAutosize
                ...
                className="text-5xl z-[99999] bg-transparent font-bold break-words
